    ...
    <div class="row justify-content-center h-100 align-items-center">
        ...
        <div class="col-lg-6 col-md-8">
            <div class="contLogin w-100">
                ...
                <form class="formLogin" action="{{ route('auth.update.password') }}" method="POST">
                    @method('put')
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="password_confirmation" class="form-control @error('password_confirmation') validation @enderror" placeholder="Enter Your Password">
